# https://github.com/voxelmorph/voxelmorph/blob/master/voxelmorph/torch/modelio.py
import logging
...
def store_config_args(func):
    ...
    def wrapper(self, *args, **kwargs):
        if hasattr(self, 'config'):
            # if the config already exists due to heredity, we should not be overwriting it
            logging.warning('MODELIO: Config already exists in object, not overwriting.')
