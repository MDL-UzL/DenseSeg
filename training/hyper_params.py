...
hp_parser.add_argument('--uv_loss', choices=['l1', 'l2', 'smoothl1'], default='l1', help='uv loss function')
hp_parser.add_argument('--beta', type=float, default=0.1, help='beta for smooth l1 loss')